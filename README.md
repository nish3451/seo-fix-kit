...
- SEO/GEO readiness checks for crawlable answer content, entity clarity, useful schema, internal context, and optional llms.txt boundaries. The app does not claim llms.txt is required for Google Search.
