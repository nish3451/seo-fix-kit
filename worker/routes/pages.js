...
${pageSocialHead({ origin, title, description, path: "/proof" })}
    <style>
      ...
      a { color: #98f0cc; font-weight: 780; text-decoration: none; }
      header { align-items: center; display: flex; justify-content: space-between; margin-bottom: 54px; }
      h1 { font-size: clamp(40px, 7vw, 84px); letter-spacing: 0; line-height: .92; margin: 0 0 16px; max-width: 820px; }
      ...
      .receipt { background: rgba(7,13,10,.58); border: 1px solid rgba(152,240,204,.18); border-radius: 8px; padding: 18px 22px; margin: 20px 0; }
