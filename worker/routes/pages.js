  ...
  return publicProductPageHtml({
    ...
    body: `
      ...
      <section class="band">
        ...
        <p>Five free tools already publish a static-vs-rendered or JavaScript-blind-crawler check, and they deserve a straight answer rather than a feature table.</p>
        <ul class="check-list">
          ...
          <li><a href="https://joshuaopolko.com/aiscan/" rel="nofollow noopener" target="_blank">joshuaopolko.com AI Readiness Scanner</a> is a free, no-signup GEO readiness scan (5, 10, or 20 pages per domain, or one pasted URL) with deterministic scores in under 30 seconds: per-bot robots.txt access for 14 AI crawlers plus live HTTP verification, JSON-LD structured-data coverage, citability structure, sitemap and IndexNow health, and client-side rendering detection — its own framing is that CSR-only content is "invisible to 11 of 14 AI crawlers" because Google-Extended, Bingbot, and Applebot are headless and do render JavaScript.</li>
          <li><a href="https://www.npmjs.com/package/openaeo-audit" rel="nofollow noopener" target="_blank">openaeo-audit</a> (open-source MIT, <a href="https://github.com/charlacsina/openaeo-audit" rel="nofollow noopener" target="_blank">charlacsina/openaeo-audit</a>) is a zero-dependency terminal check: <code>npx openaeo-audit yoursite.com</code> fetches the page the way an AI crawler does — raw HTML, no JavaScript execution — and scores it out of 100 across raw-HTML readability, per-bot robots.txt rules for GPTBot, ClaudeBot, and PerplexityBot, llms.txt presence, Organization/WebSite and FAQPage JSON-LD, priced-offer schema, answer-first opening copy, and dateModified freshness, with a --json mode.</li>
        </ul>
