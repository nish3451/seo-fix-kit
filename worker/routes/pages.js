  ...
  return publicProductPageHtml({
    ...
    body: `
      ...
      <section class="band">
        ...
        <ul class="check-list">
          <li>Anonymous one-page checks at <a href="${origin}/check">${origin}/check</a>: paste a public URL and get rendered proof, guarded false positives, and actionable findings when present, with no account and nothing stored.</li>
