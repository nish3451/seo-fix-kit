...
- Private reports can create repair queue items and approval-safe action records.
- Developer API issue/report responses include safe repair queue status and repair-action lifecycle webhooks; proposed change text stays private to owner report surfaces.
