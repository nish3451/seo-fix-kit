  ...
  return [
    ...
    },
    {
      ...
      expectations: [
        ...
        { reason: "names joshuaopolko.com AI Readiness Scanner", match: "joshuaopolko.com AI Readiness Scanner" },
        { reason: "links the joshuaopolko aiscan scanner", match: "https://joshuaopolko.com/aiscan/" },
        { reason: "names openaeo-audit npm package", match: "openaeo-audit" },
        { reason: "links npmjs openaeo-audit page", match: "https://www.npmjs.com/package/openaeo-audit" },
